      ...
      "Farm Management": [
        {
          ...
          id: "D01-S01",
          ProblemContext:
            "Farmers rely on intuition; rainfall variability and soil degradation reduce yields.",
          ChallengeStatement:
            "Build an AI + IoT system for real-time irrigation, fertilizer, and pesticide optimization.",
          ExpectedFeatures:
            "Multi-sensor soil/weather data, predictive irrigation, drone pest detection, local-language dashboard, offline mode.",
          EvaluationCriteria:
            "Accuracy, affordability, localization, sustainability.",
        ...
        },
        {
          ...
          ExpectedFeatures:
            "Soil moisture sensors, predictive water scheduling, low-power devices.",
      ...
      "Supply Chain & Health": [
        {
          ...
          id: "D01-S02",
          ProblemContext:
            "Post-harvest losses due to poor logistics and cold-chain gaps.",
          ChallengeStatement:
            "AI-driven supply chain optimization for storage, transport, and pricing.",
          ExpectedFeatures:
            "IoT cold-chain monitoring, demand forecasting, blockchain traceability.",
        ...
        },
        {
          ...
          ChallengeStatement:
            "Drone/camera-based early pest and disease detection.",
          ExpectedFeatures:
            "Image-based ML models, automated alerts, treatment recommendations.",
          EvaluationCriteria:
            "Detection accuracy, usability, and affordability.",
      ...
      "Predictive Systems": [
        {
          ...
          ExpectedFeatures:
            "Anomaly detection, RUL estimation, SHAP/LIME explainability, ERP integration.",
        ...
        },
        {
          ...
          ExpectedFeatures:
            "ML-driven forecasting, visualization dashboards, ERP integration.",
      ...
      "Responsible AI": [
        {
          ...
          ExpectedFeatures:
            "Bias detection, explainability dashboards, ethical compliance.",
        ...
        },
        {
          ...
          ExpectedFeatures:
            "Satellite data analysis, risk forecasting, alert systems.",
      ...
      "Diagnostics & Treatment": [
        {
          ...
          id: "D04-S01",
          ProblemContext:
            "Delayed or inaccurate diagnoses reduce patient outcomes.",
          ChallengeStatement:
            "Develop AI-driven diagnostic support for imaging and vitals.",
          ExpectedFeatures:
            "ML for X-ray/MRI/ECG interpretation, explainability, doctor dashboards.",
          EvaluationCriteria:
            "Diagnostic accuracy, compliance with medical standards, usability.",
          ExpectedImpact:
            "Faster, more accurate diagnoses and improved patient care.",
        },
        {
          ...
          ChallengeStatement:
            "Enable early detection through wearables and AI.",
          ExpectedFeatures:
            "Continuous monitoring, anomaly detection, personalized alerts.",
      ...
      "Access & Management": [
        {
          ...
          ExpectedFeatures:
            "IoT vitals monitoring, secure video consultations, multilingual support.",
        ...
        },
        {
          ...
          ChallengeStatement:
            "Predict and optimize hospital resource allocation.",
          ExpectedFeatures:
            "Demand forecasting, dashboards for staff, integration with hospital systems.",
          EvaluationCriteria: "Forecast accuracy, usability, scalability.",
          ExpectedImpact:
            "Optimized hospital operations and reduced patient wait times.",
        },
      ],
    },
  },
      ...
      "Threat Detection": [
        {
          ...
          ChallengeStatement:
            "Build AI-driven intrusion detection and automated response.",
          ExpectedFeatures:
            "ML anomaly detection, automated workflows, SIEM/SOAR integration.",
          EvaluationCriteria:
            "Detection accuracy, latency, automation effectiveness.",
        ...
        },
        {
          ...
          ChallengeStatement:
            "Implement Zero Trust security for hybrid infrastructures.",
          ExpectedFeatures:
            "Identity-based access, continuous monitoring, compliance checks.",
      ...
      "Privacy & Neural Security": [
        {
          ...
          ExpectedFeatures:
            "Neural hashing, anomaly detection, privacy enforcement.",
      ...
      "Infrastructure & Mobility": [
        {
          ...
          ExpectedFeatures:
            "Real-time data ingestion, predictive maintenance, digital twins.",
          EvaluationCriteria:
            "Scalability, visualization quality, interoperability.",
        ...
        },
        {
          ...
          ExpectedFeatures:
            "Smart traffic signals, predictive routing, multimodal transport integration.",
      ...
      "Sustainability & Safety": [
        {
          ...
          id: "D06-S03",
          ProblemContext:
            "Inefficient waste and water systems harm sustainability.",
          ChallengeStatement:
            "IoT-enabled waste segregation and water management platforms.",
          ExpectedFeatures:
            "Smart bins, recycling analytics, water quality sensors.",
        ...
        },
        {
          ...
          id: "D06-S04",
          ProblemContext:
            "Delayed disaster response and poor hazard detection put urban populations at risk.",
          ChallengeStatement:
            "Build AI-based hazard and disaster detection systems with real-time alerts.",
          ExpectedFeatures:
            "Sensor integration, predictive analytics, citizen alert systems, mobile dashboards.",
          EvaluationCriteria: "Accuracy, latency, usability, scalability.",
          ExpectedImpact:
            "Safer communities, faster emergency response, reduced casualties.",
        },
      ],
    },
  },
      ...
      "Security & Payments": [
        {
          ...
          ChallengeStatement:
            "Build AI-enabled fraud detection and risk analytics.",
          ExpectedFeatures:
            "ML anomaly detection, blockchain trails, risk scoring dashboards.",
          EvaluationCriteria:
            "Detection accuracy, false-positive reduction, compliance.",
          ExpectedImpact:
            "Safer transactions and stronger trust in digital finance.",
        },
        {
          title: "Digital Payments",
          id: "D07-S02",
          ProblemContext:
            "Micropayments and cross-border transactions need secure, low-cost solutions.",
          ChallengeStatement:
            "Develop secure, inclusive digital payment systems.",
          ExpectedFeatures:
            "Blockchain wallets, multilingual/voice interfaces, real-time settlement.",
          EvaluationCriteria: "Security, usability, scalability.",
          ExpectedImpact:
            "Inclusive digital economy and financial accessibility.",
        },
      ],
      "Inclusion & Compliance": [
        {
          ...
          id: "D07-S03",
          ProblemContext:
            "Unbanked populations lack access to credit and financial services.",
          ChallengeStatement:
            "AI-driven credit scoring for underserved groups.",
          ExpectedFeatures:
            "Alternative data analysis, mobile-first design, micro-lending integration.",
        ...
        },
        {
          ...
          id: "D07-S04",
          ProblemContext:
            "Compliance is complex and costly for financial institutions.",
          ChallengeStatement: "Automate regulatory compliance and monitoring.",
          ExpectedFeatures:
            "AML/KYC automation, adaptive rule engines, compliance dashboards.",
          EvaluationCriteria: "Compliance readiness, efficiency, scalability.",
          ExpectedImpact:
            "Easier regulation adherence and reduced compliance costs.",
        },
      ],
    },
  },
      ...
      "Quantum Security": [
        {
          ...
          ExpectedFeatures:
            "Lattice/hash algorithms, PQC compliance, hybrid encryption.",
        ...
        },
        {
          ...
          ExpectedFeatures:
            "Quantum key distribution, secure APIs, interoperability with 5G/IoT.",
          EvaluationCriteria: "Security, interoperability, scalability.",
          ExpectedImpact:
            "Unbreakable communications for critical infrastructure.",
        },
      ],
      "Advanced Computing": [
        {
          ...
          id: "D08-S02",
          ProblemContext:
            "Classical ML struggles with complex, high-dimensional data.",
          ChallengeStatement: "Develop hybrid quantum-classical ML models.",
          ExpectedFeatures:
            "Quantum simulators, hybrid pipelines, benchmarking.",
        ...
        },
        {
          ...
          ExpectedFeatures:
            "Neuromorphic chips, low-power ML, adaptive architectures.",
      ...
      "Carbon & Energy": [
        {
          ...
          id: "D09-S01",
          ProblemContext:
            "Lack of real-time carbon data delays climate action.",
          ChallengeStatement:
            "Build AI-driven carbon/resource tracking platforms.",
        ...
        },
        {
          ...
          ExpectedFeatures:
            "Smart grid optimization, demand forecasting, renewable integration.",
      ...
      "Circular Economy & Risk": [
        {
          ...
          ExpectedFeatures:
            "Recycling analytics, material recovery optimization, supply chain integration.",
        ...
        },
        {
          ...
          ExpectedFeatures:
            "Climate data analytics, risk dashboards, scenario simulations.",
    ...
    subdomains: {
      "Personalized Learning": [
        {
          ...
          ExpectedFeatures:
            "User profiling, adaptive recommendations, gamified assessments.",
          EvaluationCriteria:
            "Personalization accuracy, inclusivity, accessibility.",
      ...
      "Accessibility & Support": [
        ...
        },
        {
          ...
          ExpectedFeatures:
            "Automated grading, feedback dashboards, analytics.",
          EvaluationCriteria: "Accuracy, usability, scalability.",
      ...
      "Space Operations": [
        {
          ...
          id: "D11-S01",
          ProblemContext:
            "Satellite constellations face risks from debris, cyber intrusions, and hostile interference.",
          ChallengeStatement:
            "Build an AI-driven autonomous monitoring system for satellite threat detection.",
          ExpectedFeatures:
            "ML anomaly detection in orbital parameters, predictive collision avoidance, cybersecurity layers, visualization dashboards.",
          EvaluationCriteria:
            "Detection accuracy, autonomy, integration feasibility.",
        ...
        },
        {
          ...
          id: "D11-S02",
          ProblemContext:
            "Space debris threatens satellites and future missions.",
          ChallengeStatement:
            "Develop AI systems for debris tracking and collision avoidance.",
          ExpectedFeatures:
            "Orbital modeling, predictive analytics, visualization of risk zones.",
          EvaluationCriteria: "Accuracy, scalability, usability.",
          ExpectedImpact:
            "Reduced collision risks and sustainable space exploration.",
        },
      ],
      "Defense Systems": [
        {
          ...
          id: "D11-S03",
          ProblemContext:
            "Defence operations require rapid, data-driven decision-making.",
          ChallengeStatement:
            "Create AI-driven battlefield simulations and decision support systems.",
          ExpectedFeatures:
            "Real-time simulations, predictive modeling, secure integration with command systems.",
        ...
        },
        {
          ...
          id: "D11-S04",
          ProblemContext:
            "Defence communications are vulnerable to interception and disruption.",
          ChallengeStatement:
            "Build quantum-safe satellite communication systems.",
          ExpectedFeatures:
            "Quantum key distribution, secure protocols, interoperability with existing systems.",
      ...
      "Collaborative Innovation": [
        {
          ...
          id: "D12-S01",
          ProblemContext:
            "Many innovative ideas fail to scale due to fragmented collaboration between startups, academia, and industry.",
          ChallengeStatement: "",
          ExpectedFeatures: "",
          EvaluationCriteria: "",
          ExpectedImpact: "",
